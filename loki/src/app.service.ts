...
import {Transactions, TransactionDocument} from "./Schemas/transactions.schema";
import {InjectModel} from "@nestjs/mongoose";
import {Model, Schema, SaveOptions} from "mongoose";
import * as mongoose from "mongoose";


@Injectable()
export class AppService {
  constructor(@InjectModel(Transactions.name) private transactionModel: Model<Transactions>) {
  }
async findAll (){
/*    const create = new this.transactionModel({
      details:"FAKE",
...
*/
  ...
  if (transaction){
    ...
    throw new BadRequestException('no transaction with that id')
  }
